...
[^31]: And which I've now open-sourced at https://github.com/augchan42/wp-ali-public so you don't have to spend 5 hours debugging SSH key newlines and expect scripts. You're welcome.
...
For those who want the full journey, here's the [GitHub repository](https://github.com/augchan42/wp-ali-public) with all 29 commits. You can watch in real-time as I:

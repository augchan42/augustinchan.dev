...
export default function AboutPage() {
  return (
    <div>
      ...
      <p style={{ fontSize: '1.1em', color: 'var(--text-secondary)', marginBottom: '3rem' }}>
      ...
      <section style={{ marginBottom: '3rem' }}>
        <h2 style={{ fontSize: '1.3em', marginBottom: '1.5rem', borderBottom: '2px solid var(--border-strong)', paddingBottom: '0.5rem' }}>
          Current Projects
        </h2>
        ...
        <div style={{
          ...
          <p style={{ margin: '0.5rem 0', color: 'var(--text-muted)', fontSize: '0.9em' }}>
      ...
      <details style={{ marginBottom: '2rem' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.9em', color: 'var(--text-muted)', marginBottom: 0 }}>
